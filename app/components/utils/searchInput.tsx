...
const SearchInput = () => {
    ...
    return (
        <div className={`w-[400px] flexx px-4 border border-gray-200 dark:border-[#222] rounded-md ${isFocus ? 'border-transparent ring-[1.5px] ring-blue-700' : ''}`}>
            ...
            <div className="flexx flex-1">
                <input type="text" value={searchTerm}
                    ...
                    className='text-[15px] flex-1 py-2 border-none outline-none text-gray-700 dark:text-gray-300 mr-3 bg-transparent focus:ring-0'/>
