...
import { cloudinaryFetch } from '@/app/lib/util'
...
const BottomNavAccountInfo = ({showDropdown, isLoading, setIsLoading, setShowBottomNav}: PropsTypes) => {
    ...
    const handleImage = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            console.log(error)
            toast.error('Something new error')
        } finally {
            setIsLoading(false)
    ...
    return (
        <div className={`absolute right-0 z-10 ${!showDropdown ? '-bottom-[100px]' : 'bottom-0'} bg-gray-50 shadow w-full py-5 dark:bg-[#222] duration-300 rounded-b-lg`}>
...
export default BottomNavAccountInfo